...
import MaskInput from "Components/InputMask/MaskInput";
        ...
        <div className={styles.contact_wrapper}>
          ...
          >
            <Grid container spacing={2}>
              <Grid item xs={6}>
                <div className={styles.input}>
                  <label for="firstName">Name <span className="redLetters">*</span></label>
                  <input
                    type="text"
              ...
              <Grid item xs={6}>
                <div className={styles.input}>
                  <label for="email">{t("Email")} <span className="redLetters">*</span></label>
                  <input
                    type="email"
              ...
              <Grid item xs={6}>
                <div className={styles.input}>
                  <label for="phoneNumber">{t("Phone number")} <span className="redLetters">*</span></label>
                  <MaskInput
            ...
            <div className={styles.service}>
              <p className={styles.services}>{t("Choose Services")} <span className="redLetters">*</span></p>
              <Grid container spacing={2}>
                <Grid xs={6}>
                  <label for="communication">{t("Communication")}</label>
                  <input
                    type="checkbox"
                  ...
                  {errors.communication && (
                    <p className={styles.errorMessage}>
                      {t("Company Name field should not contain symbols")}
                    </p>
                  )}
                </Grid>
              </Grid>
            ...
            <Button variant="contained" type="submit" className={styles.button}>{t("Submit")}</Button>
          </form>
        </div>
      </Container>
    </div>
